...
function write2DBActionArr(arrType, arrCreatedOnDate, arrCreatedOnTime, arrTextarea, result) {
    for (i = 0; i < arrType.length; i++) {
        (function (i) {
            write2DBActionArr2(arrType[i], arrCreatedOnDate[i], arrCreatedOnTime[i], arrTextarea[i], result)
        })(i);
...
async function write2DBActionArr2(type, date, time, text, result) {
